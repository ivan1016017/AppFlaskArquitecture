...
# these classes always return JSON format s
...
class VistaCancion(Resource):
    ...
    def put(self, id_cancion):
        ...
        cancion.titulo = request.json.get('titulo', cancion.titulo)
        cancion.segundos = request.json.get('titulo', cancion.segundos)
        cancion.interprete = request.json.get('titulo', cancion.interprete)
